...
int main()
{
   ...
   cin >> size;
   vector<int> commonData = set_common_data(size);
   while (true)
   {
      cout << "Choose operation" << endl;
      cout << "1. Add value to the start" << endl;
      cout << "2. Add value to the end" << endl;
      cout << "3. Add value at the index" << endl;
      cout << "4. Remove value at the start" << endl;
      cout << "5. Remove value at the end" << endl;
      cout << "6. Remove value at the index" << endl;
      cout << "7. Search for a value" << endl;
      cin >> operation;
      if (operation == 3 || operation == 5)
      {
         cout << "At what index do you want to make changes?: ";
         cin >> place;
      }
      ...
      case 1:
      {
         ...
         case 1:
         {
            ...
            for (int i = 0; i < 100; i++)
            {
               ...
               arrays[i]->add_first(1);
               auto stop = high_resolution_clock::now();
               test_time += duration_cast<nanoseconds>(stop - start).count();
            }
            cout << "This operation took " << test_time / 100 << " nanoseconds" << endl;
         }
         break;
         case 2:
         {
   ...
   // NA KODZIE PONIŻEJ BYŁY TESTOWANE STRUKTURY
