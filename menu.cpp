...
void menu() {
    ...
    cin >> list;
    while (true) {  // Lista operacji do wykoniania na liście pokazuje się do czasu chęci zakończenia pracy przez użytkownika
        cout << "\nSelect operation:\n"
        ...
        if (operation >= 1 && operation <= 3 || operation == 7) {
            cout << "Enter value: ";
            cin >> val;
            if (operation == 3) { // Dla operacji 3 dodatkowo wymagana jest pozycja
                cout << "Enter position: ";
                cin >> place;
            }
        }
        if (operation == 6) { // Dla operacji 6 wymagana jest tylko pozycja
            cout << "Enter position: ";
            cin >> place;
        }
        if (operation < 1 || operation > 9) { // Jeżeli została wybrana inna operacja niż 1-9 wyświetli ponownie listę operacji
        ...
        case 1:
            ...
            case 8: dynList->load(); break;
            case 9: dynList->save(); break;
        ...
        case 2:
            ...
            case 8: linkedList->load(); break;
            case 9: linkedList->save(); break;
            default: cout << "Invalid operation.\n";
            }
            break;
        case 3:
            ...
            case 8: doubleList->load(); break;
            case 9: doubleList->save(); break;
            default: cout << "Invalid operation.\n";
            }
            break;
        default:
        ...
        cin >> cont;
        if (cont == 'y' || cont == 'Y') {
            switch (list) { // Automatycznie wybiera listę do wyświetlenia
